    ...
    <div class="report" :class="print ? 'report--print' : ''">
      ...
      <div ref="section1" :name="sections[0].label" class="page">
        ...
        <div class="b-table w-full mt-2">
          ...
          <div class="b-table__title">
            Leading Indicator: Fall Performance, Grades 9-11, Star Math &
            Reading
          </div>
          <table v-if="loaded" class="table-fixed">
            <thead>
              ...
              <tr class="b-table__header-row">
                ...
                <th class="b-table__header-row-value">
                  ...
                  <sup>
                    {{
                      ssMetric(
                        `4|4.1|STAR|All|Grade 9|participating|${currentCycle}`
                      )
                    }}
                  </sup>
                </th>
                ...
                <th class="b-table__header-row-value">
                  ...
                  <sup>
                    {{
                      ssMetric(
                        `4|4.1|STAR|All|Grade 9|at_grade|${currentCycle}`
                      )
                    }}
                  </sup>
                </th>
...
export default {
  ...
  computed: {
    ...
    footnotesSection3() {
      let values = [
        ...
        this.ssMetric(
          `4|4.1|STAR|All|Grade 9|participating|${this.currentCycle}`,
          'text'
        ),
        this.ssMetric(
          `4|4.1|STAR|All|Grade 9|at_grade|${this.currentCycle}`,
          'text'
        ),
      ]
      values = values.filter((text) => text?.length > 0)
  ...
  methods: {
    isCycleCurrentOrEarlier(cycle) {
      ...
      } else if (this.currentCycle === 'Fall') {
